...
class Dbg {
    ...
    getBuilderMenus() {
        ...
        //
        kvs0[4].eng = "ClassTest";
        kvs0[4].id = "classTest";
        kvs0[4].menus=this.getMenus(kvs0[4].id, 8);
        var kvs04=kvs0[4].menus.kvTexts;
        ...
        //==========================================================
        kvs04[0].id="showOscilloscope";
        kvs04[0].eng="Show Oscilloscope";
        kvs04[0].image = "systemResource/icons8-info-64.png";
        kvs04[1].id="showLineChart";
        kvs04[1].eng="Show Line Chart";
        kvs04[1].image = "systemResource/icons8-info-64.png";
