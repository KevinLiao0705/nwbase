...
class SubOpts {
    static init() {
        ...
        if ("Component~Cp_base~icons.led"){
            ...
            opts.backgroundImageUrls.push("systemResource/white_led_dark_64x64.png");
            opts.backgroundImageUrls.push("systemResource/white_led_glow_64x64.png");
            opts.backgroundImageUrls.push("systemResource/green_led_dark_64x64.png");
            opts.backgroundImageUrls.push("systemResource/green_led_glow_64x64.png");
            opts.backgroundImageUrls.push("systemResource/red_led_dark_64x64.png");
            opts.backgroundImageUrls.push("systemResource/red_led_glow_64x64.png");
            opts.backgroundInx=0;
            opts.baseColor="rgba(0,0,0,0)";
        }
